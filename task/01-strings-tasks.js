...
function getRectangleString(width, height) {
    ...
    return top + body.repeat(height) + bottom;
}
...
function encodeToRot13(str) {
    ...
    var original = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz',
        projection = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';

    return str.replace(/([A-Za-z])/g, s => projection[original.indexOf(s)] );
}
...
function getCardId(value) {
    ...
    return array.findIndex( s => s===value );
}

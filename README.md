...
## Javascript Assignments  [![Build Status](https://travis-ci.org/Serbovv/js-assignments.svg?branch=master)](https://travis-ci.org/Serbovv/js-assignments)
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/Serbovv/js-assignments/builds).
